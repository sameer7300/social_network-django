...
from .froms import RoomForm , UserForm, MyUserCreationFarm
...
# rooms = [
#     {'id': 1, 'name': 'Let\'s Learn Python!'},  # Escape special characters
...
def registerUser(request):
     ...
     form = MyUserCreationFarm
     if request.method == 'POST':
          form = MyUserCreationFarm(request.POST )
          if form.is_valid():
